...
class ServerQuery {
  ...
  Future<void> post_method(
    ...
    await http
        .post(Uri.parse(api_url), headers: header, body: json.encode(query))
        .then((value) {
      if (value.statusCode == 200) {
        ...
        serverOperationCompletion.onError(url, 'logout_title',
            'server_logout_message', value.statusCode, context, value);
      }
      ...
      serverOperationCompletion.onError(
          url, "Error", onError.toString(), 0, context, responseVale);
    });
  }


  Future<void> get_method(
      BuildContext context,
      String url,
      Map<String, String> header,
      Map<String, dynamic> query,
  ...
  Future<void> get_method_query_parameter(
      BuildContext context,
      String url,
      Map<String, String> header,
      Map<String, dynamic> query,
      ServerOperationCompletion serverOperationCompletion) async {
    final api_url =
    Uri.https(ServerConstant().base_url, url, query);
